...
import numpy as np
import dataset.myDataset as dataset
import torch
...
#Method options
parser.add_argument('--n-labeled', type=int, default=600,
...
def main():
    ...
    train_labeled_set, train_unlabeled_set, val_set, test_set = dataset.get_myDataset('./data', args.n_labeled, transform_train=transform_train, transform_val=transform_val)
